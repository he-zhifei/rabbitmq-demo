package com.zhifei.reliabledelivery.config;
...
public class DruidDataSourceConfig {
     ...
     * Mapper接口包路径
     */
    public static final String PACKAGE = "com.zhifei.reliabledelivery.dao";

    /**
     * 该包下的实体类，在mybatis的xml中可以使用别名
     */
    public static final String TYPE_ALIASES_PACKAGE = "com.zhifei.reliabledelivery.entity";
