package com.zhifei.reliabledelivery.consumer;

import com.alibaba.fastjson.JSON;
import com.zhifei.reliabledelivery.dao.UniqueMessageIdMapper;
...
public class RabbitReceiver {
    ...
    public void onOrderMessage(
            @Payload com.zhifei.reliabledelivery.entity.Order order,
    ...
    public void onContainerMessage(
            @Payload com.zhifei.reliabledelivery.entity.MessageContainer<User> container,
            @Headers Map<String, Object> headers,
            Channel channel) {
        long deliveryTag = (long) headers.get(AmqpHeaders.DELIVERY_TAG);
        try {
