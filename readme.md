```
一、api-test：RabbitMQ基础api使用

二、rabbitmq-springboot-test：RabbitMQ与SpringBoot整合，使用单元测试方式测试消息生产者与消费者

三、reliable-delivery-consumer：RabbitMQ整合SpringBoot实现可靠性投递--消费者

四、reliable-delivery-producer：RabbitMQ整合SpringBoot实现可靠性投递--生产者
整体流程：
